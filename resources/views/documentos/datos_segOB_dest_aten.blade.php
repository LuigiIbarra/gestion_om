    <div class="modal fade" id="OBSeguimModal" tabindex="-1" aria-labelledby="OBSeguimModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="OBSeguimModalLabel">Seguimiento Obras, Mantenimiento y Servicios</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="formOBsegatt" method="POST" action="{{ url('destatencion/OBseguimiento') }}">
                    @csrf
                        <div class="d-none">
                            <input type="text" name="obdaid_docto" id="obdaid_docto" value="{{ $documento->iid_documento }}">
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            <div class="col" id="divOBsegarchivo">
