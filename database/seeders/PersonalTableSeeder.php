...
class PersonalTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tcpersonal')->insert(['cnombre_personal'=>'MOISES','cpaterno_personal'=>'PRATS','cmaterno_personal'=>'VILLERS','iid_puesto'=>55,'iid_adscripcion'=>24,'ccorreo_electronico'=>'moises.prats@tsjcdmx.gob.mx','iestatus'=>'1','iid_usuario'=>1,'created_at'=>Carbon::now()->format('Y-m-d H:i:s')]);
