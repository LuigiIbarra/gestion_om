                <div class="row">
                    <div class="col" id="divfoliorel">
                        ...
                        <input type="text" id="folio_relacionado" name="folio_relacionado" class="form-control" data-target="#folio_relacionado" value="{{$folio_relacionado->cfolio_relacionado}}" required />
                    </div>
