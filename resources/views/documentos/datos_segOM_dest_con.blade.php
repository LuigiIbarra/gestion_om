    <div class="modal fade" id="COMSeguimModal" tabindex="-1" aria-labelledby="COMSeguimModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="COMSeguimModalLabel">Seguimiento Conocimiento Oficialía Mayor</h5>
                    <button type="button" class="close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form id="formOMsegcon" method="POST" action="{{ url('destconoc/seguimiento') }}">
                    @csrf
                        <div class="d-none">
