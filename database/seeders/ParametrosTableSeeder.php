...
class ParametrosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('parametros')->insert(['ianio'=>'2023','iultimo_folio'=>'0','cleyenda_anual_oficios'=>'"2023 Año de Francisco Villa, el revolucionario del pueblo"','created_at'=>Carbon::now()->format('Y-m-d H:i:s')]);
    }
}
