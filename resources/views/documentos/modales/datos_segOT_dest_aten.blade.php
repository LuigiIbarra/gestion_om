                    ...
                    @csrf
                        ...
                        <div class="row">
                            <div class="col" id="divnomotrapersona">
                                ...
                                @if($destAt->otropersonal!=null)
                                    <input type="text" id="otro_nombre" name="otro_nombre" class="form-control" data-target="#otro_nombre" value="{{ $destAt->otropersonal->cnombre_personal }}" maxlength="100" required {{ $noeditar }} />
                                @else
                        ...
                        <div class="row">
                            <div class="col" id="divpatotrapersona">
                                ...
                                @if($destAt->otropersonal!=null)
                                    <input type="text" id="otro_paterno" name="otro_paterno" class="form-control" data-target="#otro_paterno" value="{{ $destAt->otropersonal->cpaterno_personal }}" maxlength="100" required {{ $noeditar }} />
                                @else
                        ...
                        <div class="row">
                            <div class="col" id="divotropuesto">
                                ...
                                @if($destAt->otropuesto!=null)
                                    <input type="text" id="otro_puesto" name="otro_puesto" class="form-control" data-target="#otro_puesto" value="{{ $destAt->otropuesto->cdescripcion_puesto }}" maxlength="100" required {{ $noeditar }} />
                                @else
                        ...
                        <div class="row">
                            <div class="col" id="divotraads">
                                ...
                                @if($destAt->otraadscripcion!=null)
                                    <input type="text" id="otra_adscripcion" name="otra_adscripcion" class="form-control" data-target="#otra_adscripcion" value="{{ $destAt->otraadscripcion->cdescripcion_adscripcion }}" maxlength="100" required {{ $noeditar }} />
                                @else
