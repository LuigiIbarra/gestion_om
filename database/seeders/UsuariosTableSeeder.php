...
class UsuariosTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('users')->insert(['name'=>'KARINA HERNÁNDEZ HERNÁNDEZ','email'=>'karina.hernandez@tsjcdmx.gob.mx','password' => bcrypt('12345678'),'iid_rol'=>2,'created_at'=>Carbon::now()->format('Y-m-d H:i:s')]);
    }
}
